...
public enum Errors {
    ...
    OSA_HIGH_THRESHOLD_ERROR(15, OSA_HIGH_THRESHOLD_ERROR_MSG),
    OSA_MEDIUM_THRESHOLD_ERROR(16, OSA_MEDIUM_THRESHOLD_ERROR_MSG),
    OSA_LOW_THRESHOLD_ERROR(17, OSA_LOW_THRESHOLD_ERROR_MSG),
