...
class ArgDescriptions {
    ...
    static final String INCLUDE_EXCLUDE_PATTERN = "Comma separated list of file name patterns to exclude from scan. For example, exclude all files with '.class' extension: -LocationFilesExclude *.class Optional";
