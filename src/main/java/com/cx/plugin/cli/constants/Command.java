...
public enum Command {
    ...
    private static final List<String> commandValues = new ArrayList<>();

    static {
        for (Command command : Command.values()) {
            commandValues.add(command.value.toLowerCase());
        }
    }
    ...
    public static Options getOptions() {
        ...
        options.addOption(Parameters.GENERATE_TOKEN, true, Constants.CX_TOKEN_DESC);
        options.addOption(Parameters.REVOKE_TOKEN, true, Constants.CX_TOKEN_DESC);
        ...
        options.addOption(OSA_ENABLED, true, Constants.OSA_ENABLED_DESC);
        options.addOption(OSA_JSON_REPORT, true, Constants.OSA_JSON_REPORT_DESC);
        options.addOption(INSTALL_PACKAGE_MANAGER, true, Constants.INSTALL_PACKAGE_MANAGER_DESC);
        ...
        options.addOption(IS_INCREMENTAL, true, Constants.IS_INCREMENTAL_DESC);
        options.addOption(IS_FORCE_SCAN, true, Constants.IS_FORCE_SCAN_DESC);
        options.addOption(IS_PRIVATE, true, Constants.IS_PRIVATE_DESC);
